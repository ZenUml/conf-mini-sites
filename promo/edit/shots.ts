...
export const SHOTS: Shot[] = [
  ...
  { id: 'pick-folder',   t: 12.45, dur: 1.10, src: 'act2', at: ['a2_files_selected', -0.80], zoom: 1.25,
    evidence: 'A whole project folder goes in — not a screenshot, not a single file.' },
  { id: 'file-list',     t: 13.55, dur: 1.00, src: 'act2', at: ['a2_filelist_shown', -0.25], zoom: 1.25,
    evidence: 'index.html, styles.css, app.js, assets/ — it really is the multi-file site.' },
  { id: 'ready',         t: 14.55, dur: 1.05, src: 'act2', at: ['a2_ready_state', -0.35], zoom: 1.25,
